...
using Ainiro.Data.Sqlite.Properties;
using SQLitePCL;
using static SQLitePCL.raw;

namespace Ainiro.Data.Sqlite
{
    /// <summary>
    ...
    public class SqliteCommand : DbCommand
    {
        ...
        public SqliteCommand(string? commandText) => CommandText = commandText;
        ...
        public new virtual SqliteParameterCollection Parameters => _parameters ??= new SqliteParameterCollection();
        ...
        public new virtual SqliteParameter CreateParameter() => new();
        ...
        /// <seealso href="https://docs.microsoft.com/dotnet/standard/data/sqlite/batching">Batching</seealso>
        /// <seealso href="https://docs.microsoft.com/dotnet/standard/data/sqlite/database-errors">Database Errors</seealso>
        public new virtual Task<SqliteDataReader> ExecuteReaderAsync() => ExecuteReaderAsync(CommandBehavior.Default, CancellationToken.None);
        ...
        public new virtual Task<SqliteDataReader> ExecuteReaderAsync(CancellationToken cancellationToken) => ExecuteReaderAsync(CommandBehavior.Default, cancellationToken);
        ...
        /// <seealso href="https://docs.microsoft.com/dotnet/standard/data/sqlite/batching">Batching</seealso>
        /// <seealso href="https://docs.microsoft.com/dotnet/standard/data/sqlite/database-errors">Database Errors</seealso>
        public new virtual Task<SqliteDataReader> ExecuteReaderAsync(CommandBehavior behavior) => ExecuteReaderAsync(behavior, CancellationToken.None);
        ...
        protected override async Task<DbDataReader> ExecuteDbDataReaderAsync(
            CommandBehavior behavior,
            CancellationToken cancellationToken) => await ExecuteReaderAsync(behavior, cancellationToken).ConfigureAwait(false);
