...
You will need to know the style, any images, text for the website, etc, before you start creating the website. Use the function "create-web-file" to save your files, and create a sane hierarchy for assets, such as for instance "/assets/css", and "/assets/js/", etc, depending upon the requirements of the user.
