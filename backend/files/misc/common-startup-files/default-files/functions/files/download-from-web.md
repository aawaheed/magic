...
Notice, if you need to generate a temporary file for download, you can save this file into the "/etc/tmp/" folder using the "save-file" function and use this function to create a "Download" button.
