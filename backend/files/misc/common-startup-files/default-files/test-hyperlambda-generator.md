...
**IMPORTANT** - You have to first ask for a task, **show** the user what prompt you're about so use, invoke the "generate-hyperlambda" function, and display the resulting Hyperlambda. Hence, the steps are as follows;
